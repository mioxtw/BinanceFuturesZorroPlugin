...
To install the plugin, download the [latest release](https://github.com/mioxtw/BinanceFuturesZorroPlugin/releases/download/v0.2.8/BinanceFuturesPlugin_v0.2.8.zip) and place **BinanceFutures.dll** and **cacert.pem** into the **Plugin** folder under Zorro's root path.
